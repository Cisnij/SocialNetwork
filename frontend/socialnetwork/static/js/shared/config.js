...
export const API = {
  ...
  toggleRecord: (convId) => `${API_BASE_URL}/api/chat/conversation/${convId}/call-video/record/`,
  uploadRecording: (convId) => `${API_BASE_URL}/api/chat/conversation/${convId}/call-video/upload-recording/`,
