...
admin.site.register([ConversationMember,Message,MessageAttachment,FCMToken,Notification,SearchHistory,PostShare, Report, SupportTicket,Task,VideoRoom,CallParticipant,Event,EventParticipant,Group,GroupJoinRequest,GroupMember,GroupRole,GroupDepartment])
