...
def get_reactions_context(queryset, user):
    ...
    reactions = (
        ...
        .annotate(total=Count('reactions')) #group by theo 2 field trên và đếm , annotate tính toán ở db nên nhanh hơn, trả ra field total tính băng related name của user reaction
