...
urlpatterns = [
    ...
    path('api/user/post-video/<int:post_id>/',PostVideoListCreate.as_view(),name='post-video'),
    path('api/user/delete-video/<int:pk>/',PostVideoDelete.as_view(),name='post-video-delete'),
    ...
    path('api/user/post/<int:post_id>/save/', SavePostToggle.as_view(), name='post-save-toggle'),
    path('api/user/saved-posts/', SavedPostList.as_view(), name='saved-post-list'),
    ...
    path('api/user/reaction/message/<int:chat_id>/',UserReactionChatList.as_view(),name='user-reaction-message'), #lấy ra tất cả user đã thẻ react commment
